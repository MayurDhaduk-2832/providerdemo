...
class _OverSpeedReportScreenState extends State<OverSpeedReportScreen> {
  ...
  overSpeedReport() async {
    ...
    print(data);
    _reportProvider.overSpeedReport(data, "notifs/overSpeedReport");
  }
  ...
  void initState() {
    ...
    _reportProvider.overSpeedReportList.clear();
    _reportProvider.isOverSpeedReportLoading = false;
  }
                                              ...
                                              if ("vehicleId" != "") {
                                                if (exportType == "pdf") {
                                                  ...
                                                  for (int i = 0;
                                                      ...
                                                      i++) {
                                                    sendList.add(""
                                                        "Vehicle Name : ${_reportProvider.overSpeedReportList[i]["vehicleName"]}  "
                                                        "\n\n"
                                                        "Over Speed : ${_reportProvider.overSpeedReportList[i]["overSpeed"]}"
                                                        "\n\n"
                                                        "Address : ${_reportProvider.overSpeedAddressList[i]}"
                                                        "\n\n");
                                                  }
                                                  ...
                                                  for (int i = 0;
                                                    ...
                                                    var data = {
                                                      "a":
                                                          "${_reportProvider.overSpeedReportList[i]["vehicleName"]}",
                                                      "b":
                                                          "${_reportProvider.overSpeedReportList[i]["overSpeed"]}",
                                                      "c":
                                                          "${_reportProvider.overSpeedAddressList[i]}",
                                                      "d": "",
                                                      "e": "",
                                                      "f": "",
                                                      "g": "",
          ...
          children: [
            ...
            Container(
              ...
              child: Padding(
                ...
                child: _reportProvider.isOverSpeedReportLoading
                    ? Helper.dialogCall.showLoader()
                    : _reportProvider.overSpeedReportList.isEmpty
                        ? Center(
                            child: Text(
                              "${getTranslated(context, "overspeed_report_not_available")}",
                        ...
                        : ListView.builder(
                            ...
                            itemCount:
                                _reportProvider.overSpeedReportList.length,
                            shrinkWrap: true,
