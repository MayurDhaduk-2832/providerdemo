                  ...
                  onTap: (){
                    setState(() {
                      ...
                      _items.forEach((element) {
                        _selectedValues = widget.onItemCheckedChange(
                            _selectedValues, element.value, true);
                      });
                    });
                  },
                  child: Text(
                    "${getTranslated(context, "select_all")}",
                    style: Textstyle1.text14.copyWith(
                        color: ApplicationColors.redColor67
                    ),
                  ),
              ...
              children: <Widget>[
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: widget.searchHint ?? "${getTranslated(context, "search")}",
                ...
                IconButton(
                  icon: _showSearch
                      ...
                      : widget.searchIcon ?? Icon(Icons.search,color: Colors.white,),
                  onPressed: () {
                    setState(() {
      ...
      actions: <Widget>[
        Row(
          ...
          children: [
            Expanded(
              child: TextButton(
                style: ButtonStyle(backgroundColor: MaterialStateProperty.all(ApplicationColors.redColor67)),
